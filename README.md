...
| Passphrase generation | Implemented: offline EFF wordlist, 4–10 words (default 6), four separators, optional capitalization and a random final digit. |
| PIN generation | Not implemented. |
